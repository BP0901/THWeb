                    ...
                    <div class="container-fluid">
                        ...
                        <div class="form-group input-group">
                            ...
                            <div class="custom-control custom-radio mb-5">
                                <input type="radio" id="erdbMale" name="rad_gender" class="custom-control-input"checked>
                                <label class="custom-control-label" for="erdbMale">Nam</label>
                            </div>
                            <div class="custom-control custom-radio mb-5">
                                <input type="radio" id="erdbFemale" name="rad_gender" class="custom-control-input">
            ...
            <form action="UserController.php" method="get" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Email:</span>
                            <input type="email" name="txt_email" style="width:350px;" class="form-control" id="eemail">
                        </div>     
                    </div>
                </div>
                <div class="modal-footer">
