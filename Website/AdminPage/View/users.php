                                ...
                                <tbody>
                                    ...
                                    <?php for ($i = 0; $i < count($data['list']); $i++) { ?>
                                        <tr>
                                            ...
                                            <td id="sex<?php echo $i; ?>"><?php echo $data['list'][$i]['sex'] ? "Nữ" : "Nam" ?> </td>
                                            <td id="email<?php echo $i; ?>"><?php echo $data['list'][$i]['email'] ?></td>
                                            <?php 
                                                if($data['list'][$i]['role'] == "0"){?>
                                                    <td id="role<?php echo $i; ?>"><?php echo "Admin"?></td>
                                            <?php 
                                                } else { ?>
                                                    <td id="role<?php echo $i; ?>"><?php echo "User"?></td>
                                                    <?php } ?>      
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                        ...
                                                        class="dropdown-item" 
                                                        id="delete"
                                                        href="?action=del&&email=<?php echo $data['list'][$i]['email'] ?>">
