...
switch ($product_action) {
    ...
    case 'add':
        ...
        $error = checkProduct($product_img, $product_name, $product_desc, $product_price_cur, $product_price_sale, $product_cate);
        if (!empty($error)) {
            echo '<script>
                    alert("' . $error . '");
                    window.history.back();
            ...
            $target_dir = '../view/vendors/images/product/';
            $target_file = $target_dir . basename($product_img["name"]);
            move_uploaded_file($temp, $target_file);
            $image = './vendors/images/product/' . $name;

            $newPro = new Product($product_name, $product_desc, $product_price_cur, $image, $product_price_sale, $product_cate);
    ...
    case 'edit':
        ...
        $err = checkProductUpdate($newName, $newDesc, $newPrice, $newDiscount);
        if (empty($err)) {
            ...
            //Trường hợp có hình ảnh
                ...
                $updatePro = new Product($newName, $newDesc, $newPrice, $image, $newDiscount, $newCate, $proId);
                $count = $productController->updateProduct($updatePro);
