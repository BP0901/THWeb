              ...
              <div class="aa-product-inner">
                <!-- start prduct navigation -->
                 <ul class="nav nav-tabs aa-products-tab">
                    ...
                    <li><a href="#sports" data-toggle="tab">Thể Thao</a></li>
                    <li><a href="#electronics" data-toggle="tab">Đồ điện tử</a></li>
                  </ul>
                  <!-- Tab panes -->
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ đồ</a>
                              <figcaption>
                      ...
                      <a class="aa-browse-btn" href="#">Tìm kiếm tất cả sản phẩm <span class="fa fa-long-arrow-right"></span></a>
                    </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <div class="aa-product-view-content">
                                ...
                                <div class="aa-price-block">
                                  ...
                                  <p class="aa-product-avilability">Khả dụng:<span>Trong kho</span></p>
                                </div>
                                ...
                                <div class="aa-prod-quantity">
                                  ...
                                  <p class="aa-prod-category">
                                    Loại: <a href="#">Áo Thun Polo</a>
                                  </p>
                                </div>
                                <div class="aa-prod-view-bottom">
                                  <a href="#" class="aa-add-to-cart-btn"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ đồ</a>
          ...
          <div class="row">
            <div class="aa-popular-category-area">
             ...
             <ul class="nav nav-tabs aa-products-tab">
                ...
                <li><a href="#latest" data-toggle="tab">Cũ</a></li>                    
              </ul>
              <!-- Tab panes -->
              <div class="tab-content">
                  ...
                  <ul class="aa-product-catg aa-popular-slider">
                    ...
                    <li>
                      <figure>
                        ...
                        <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Thêm vào giỏ đồ</a>
                         <figcaption>
                          <h4 class="aa-product-title"><a href="#">Áo Thun Polo</a></h4>
                          <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        </figcaption>
                      </figure>                     
                      <div class="aa-product-hvr-content">
              ...
              <div class="col-md-4 col-sm-4">
                <div class="aa-latest-blog-single">
                  ...
                  <div class="aa-blog-info">
                    ...
                    <a href="#" class="aa-read-mor-btn">Tiếp<span class="fa fa-long-arrow-right"></span></a>
                  </div>
                </div>
              </div>
              <!-- single latest blog -->
